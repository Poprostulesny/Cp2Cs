...
public class NativeStructs
{
    ...
    public struct Camera()
    {
        ...
        public Triplet lookfrom = new(0, 0, 0); // Point camera is looking from
        public Triplet lookat = new(0, 0, -1); // Point camera is looking at
        public Triplet vup = new(0, 1, 0); // Camera-relative "up" direction
